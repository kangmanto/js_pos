...
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent), ui(new Ui::AboutDialog) {
    ...
    ui->textBrowser->setText(QStringLiteral("<center>Jaya Sentosa POS is simple POS software \
                    <br><br>Project can be found at <br><a href=\"https://github.com/kangmanto/js_pos\"> \
                    https://github.com/kangmanto/js_pos</a><br><br>\
