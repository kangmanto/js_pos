...
void Util::init(const QString &appDir) { sAppDir = appDir; }
...
bool Util::isBetaVersion(QString version) { return version.length() > 8; }
...
bool Util::hasFlag(int flag, int tocheck) { return (flag & tocheck) != 0; }

QString Util::appDir() { return sAppDir; }
