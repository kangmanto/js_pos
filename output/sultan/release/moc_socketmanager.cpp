...
#include "../../../sultan/socket/socketmanager.h"
...
QT_MOC_LITERAL(3, 31, 14), // "LibG::Message*"
QT_MOC_LITERAL(4, 46, 3), // "msg"
QT_MOC_LITERAL(5, 50, 13), // "newConnection"
QT_MOC_LITERAL(6, 64, 16), // "clientDisconnect"
QT_MOC_LITERAL(7, 81, 12), // "sendToClient"
QT_MOC_LITERAL(8, 94, 24) // "processMessageFromClient"

    },
    "SocketManager\0receivedMessage\0\0"
    "LibG::Message*\0msg\0newConnection\0"
    "clientDisconnect\0sendToClient\0"
...
void SocketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receivedMessage((*reinterpret_cast< LibG::Message*(*)>(_a[1]))); break;
        case 1: _t->newConnection(); break;
        case 2: _t->clientDisconnect(); break;
        case 3: _t->sendToClient((*reinterpret_cast< LibG::Message*(*)>(_a[1]))); break;
        case 4: _t->processMessageFromClient((*reinterpret_cast< LibG::Message*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SocketManager::*_t)(LibG::Message * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketManager::receivedMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SocketManager::receivedMessage(LibG::Message * _t1)
{
