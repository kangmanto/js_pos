...
#include "../../../sultan/http/httpserver.h"
...
struct qt_meta_stringdata_HttpClientHandler_t {
    QByteArrayData data[5];
    char stringdata0[68];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HttpClientHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HttpClientHandler_t qt_meta_stringdata_HttpClientHandler = {
    {
QT_MOC_LITERAL(0, 0, 17), // "HttpClientHandler"
QT_MOC_LITERAL(1, 18, 13), // "handleRequest"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 23), // "Pillow::HttpConnection*"
QT_MOC_LITERAL(4, 57, 10) // "connection"

    },
    "HttpClientHandler\0handleRequest\0\0"
    "Pillow::HttpConnection*\0connection"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_HttpClientHandler[] = {
...
void HttpClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HttpClientHandler *_t = static_cast<HttpClientHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject HttpClientHandler::staticMetaObject = {
    { &Pillow::HttpHandler::staticMetaObject, qt_meta_stringdata_HttpClientHandler.data,
      qt_meta_data_HttpClientHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *HttpClientHandler::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *HttpClientHandler::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_HttpClientHandler.stringdata0))
        return static_cast<void*>(const_cast< HttpClientHandler*>(this));
    return Pillow::HttpHandler::qt_metacast(_clname);
}

int HttpClientHandler::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
